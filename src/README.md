...
- Train an ML model on a classification task to predict the salary group of individuals based on 14 various characteristics.

- Developed a FastAPI app to serve the trained model
- Deployed the FastAPI app on  Heroku for real-time inference endpoint
